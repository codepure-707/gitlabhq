...
gem 'gitlab-secret_detection', '>= 0.26.2', '< 1.0', feature_category: :secret_detection

# Responders respond_to and respond_with
gem 'responders', '~> 3.1', '>= 3.1.0', feature_category: :shared

gem 'sprockets', '~> 4.2.0', feature_category: :shared
...
gem 'gitaly', '~> 17.8.5', feature_category: :gitaly

# KAS GRPC protocol definitions
gem 'gitlab-kas-grpc', '~> 17.10.5', feature_category: :deployment_management
...
# Email validation
gem 'valid_email', '~> 0.1', '>= 0.1.4', feature_category: :shared
